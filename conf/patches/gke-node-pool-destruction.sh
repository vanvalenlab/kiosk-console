...
until gcloud container node-pools delete prediction-gpu --region ${GPU_COMPUTE_REGION}
do
...
until gcloud container node-pools delete training-gpu --region ${GPU_COMPUTE_REGION}
do
...
until gcloud container node-pools delete elasticsearch-cpu --region ${GKE_COMPUTE_REGION}
do
...
until gcloud container node-pools delete rc-dp-cpu --region ${GKE_COMPUTE_REGION}
do
