...
if rtd_version not in ["master", "latest", "stable", "mrgn-docs"]:
    rtd_version = "master"
...
htmlhelp_basename = 'DeepCellKioskdoc'
...
latex_documents = [
    (master_doc, 'DeepCellKiosk.tex', 'DeepCell Kiosk Documentation',
     'Van Valen Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'deepcellkiosk', 'DeepCell Kiosk Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DeepCellKiosk', 'DeepCell Kiosk Documentation',
     author, 'DeepCellKiosk', 'One line description of project.',
     'Miscellaneous'),
]
